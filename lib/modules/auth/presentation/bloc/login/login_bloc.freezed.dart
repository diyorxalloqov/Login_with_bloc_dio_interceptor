...
class _$LoginImpl implements _Login {
  ...
  @override
  String toString() {
    return 'LoginEvent.login(onSucces: $onSucces, phone: $phone, password: $password)';
  }
...
class _$LoginStateImpl implements _LoginState {
  const _$LoginStateImpl({this.status = ActionStatus.pure});
...
abstract class _LoginState implements LoginState {
  const factory _LoginState({final ActionStatus status}) = _$LoginStateImpl;
